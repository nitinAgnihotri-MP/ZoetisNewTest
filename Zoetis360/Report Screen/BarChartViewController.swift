...
class BarChartViewController: UIViewController,IAxisValueFormatter, ChartViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        chartNameLable.frame = CGRect(x: self.view.frame.midX - 350, y: 116, width: 700, height: 30)
        chartNameLable.text = NSLocalizedString("Coccidiosis summary last session", comment: "")
