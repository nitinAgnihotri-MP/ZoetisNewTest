...
class startNecropsyXib: UIView {
    ...
    @IBOutlet weak var startNecBtn: UIButton!
    @IBOutlet weak var headLbl: UILabel!
    @IBOutlet weak var dataLbl: UILabel!
    @IBOutlet weak var bgView: UIView!
    override func draw(_ rect: CGRect) {
        headLbl.text = NSLocalizedString("No existing posting session!", comment: "")
        dataLbl.text = NSLocalizedString("start new necropsy.", comment: "")
        startNecBtn.setTitle(NSLocalizedString("Start Necropsy", comment: ""), for: .normal)
