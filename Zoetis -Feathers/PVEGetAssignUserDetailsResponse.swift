...
struct PVEGetAssignUserDetailsResponse {
    ...
    func getAssignUserDetailsResponse(dataArray:[PVEGetAssignUserDetailsRes]) -> [String] {
...
public struct PVEGetAssignUserDetailsRes {
    ...
    init(_ json: JSON) {
        ...
        CoreDataHandlerPVE().saveAssignUserDetailsInDB(id! as NSNumber, firstName: firstName!, lastName: lastName!, fullName: fullName!)
    }
