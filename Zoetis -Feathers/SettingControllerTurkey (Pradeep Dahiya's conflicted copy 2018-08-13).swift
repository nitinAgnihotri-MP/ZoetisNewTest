...
class SettingControllerTurkey: UIViewController, UINavigationControllerDelegate {
...
/************* Save Obs in To data Base *********************/
    func callSaveMethod( skeletaArr: NSArray) {
        for i in 0..<skeletaArr.count {
            ...
            if  btnTag == 0 {
                CoreDataHandlerTurkey().saveSettingsSkeletaInDatabaseTurkey(strObservationField, visibilityCheck: isVisibilityCheck, quicklinks: isQuicklinksCheck, strInformation: "xyz", index: i, dbArray: dataSkeletaArray, obsId: obsId, measure: measure, isSync: false, lngId: lngIdValue, refId: refId)

            } else if btnTag == 1 {

                CoreDataHandlerTurkey().saveSettingsCocoiiInDatabaseTurkey(strObservationField, visibilityCheck: isVisibilityCheck, quicklinks: isQuicklinksCheck, strInformation: "xyz", index: i, dbArray: dataCocoiiArray, obsId: obsId, measure: measure, isSync: false, lngId: lngIdValue, refId: refId)
            } else if btnTag == 2 {

                CoreDataHandlerTurkey().saveSettingsGITractDatabaseTurkey(strObservationField, visibilityCheck: isVisibilityCheck, quicklinks: isQuicklinksCheck, strInformation: "xyz", index: i, dbArray: dataGiTractArray, obsId: obsId, measure: measure, isSync: false, lngId: lngIdValue, refId: refId )
            } else if btnTag == 3 {

                CoreDataHandlerTurkey().saveSettingsRespiratoryDatabaseTurkey(strObservationField, visibilityCheck: isVisibilityCheck, quicklinks: isQuicklinksCheck, strInformation: "xyz", index: i, dbArray: dataRespiratoryArray, obsId: obsId, measure: measure, isSync: false, lngId: lngIdValue, refId: refId)
            } else {
                CoreDataHandlerTurkey().saveSettingsImmuneDatabaseTurkey(strObservationField, visibilityCheck: isVisibilityCheck, quicklinks: isQuicklinksCheck, strInformation: "xyz", index: i, dbArray: dataImmuneArray, obsId: obsId, measure: measure, isSync: false, lngId: lngIdValue, refId: refId )
            }
        }
    }
...
//            }
    ...
    func switchClick(_ sender: UISwitch) {
