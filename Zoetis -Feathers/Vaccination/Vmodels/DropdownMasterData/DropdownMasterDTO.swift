import Foundation
struct DropdownMasterDTO : Codable {
	let isSuccess : Bool?
	let statusCode : Int?
	let displayMessage : String?
	let responseData : MasterDataTypesDTO?
	...
	init(from decoder: Decoder) throws {
		...
		responseData = try values.decodeIfPresent(MasterDataTypesDTO.self, forKey: .responseData)
