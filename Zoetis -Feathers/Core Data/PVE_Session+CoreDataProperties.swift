//
//  PVE_Session+CoreDataProperties.swift
//  Zoetis -Feathers
//
...
extension PVE_Session {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<PVE_Session> {
        return NSFetchRequest<PVE_Session>(entityName: "PVE_Session")
    }
    ...
    @NSManaged public var isFreeSerology: NSNumber?
