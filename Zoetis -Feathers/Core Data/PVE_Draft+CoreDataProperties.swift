//
//  PVE_Draft+CoreDataProperties.swift
//  Zoetis -Feathers
//
...
extension PVE_Draft {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<PVE_Draft> {
        return NSFetchRequest<PVE_Draft>(entityName: "PVE_Draft")
    }
    ...
    @NSManaged public var objEvaluationDateStr: String?
    @NSManaged public var draftId: NSNumber?
