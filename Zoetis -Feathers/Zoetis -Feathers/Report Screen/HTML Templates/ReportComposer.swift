...
class ReportComposer: NSObject {
    ...
    func renderReports(_ complexName: String, customerName: String, vetanatrionName: String, salesRepName: String, customerRepName: String, typeDate: String, items: [[String: AnyObject]]) -> String! {
        ...
        do {
            ...
            HTMLContent = HTMLContent!.replacingOccurrences(of: "#salesRepName#", with: salesRepName.characters.count == 0 ? "NA" : salesRepName)

            HTMLContent = HTMLContent!.replacingOccurrences(of: "#customerRepName#", with: customerRepName.characters.count == 0 ? "NA" : customerRepName)
            ...
            for i in 0..<items.count+1 {
                ...
                if i != items.count {
                    ...
                    index = 0
                    itemHTMLContent = itemHTMLContent!.replacingOccurrences(of: "#Acervulina#", with: NSString(format: "%.1f", items[i]["acer"]!.floatValue) as String)
