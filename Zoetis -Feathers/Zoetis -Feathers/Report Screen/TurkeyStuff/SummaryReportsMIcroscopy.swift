...
//        webPreview.scalesPageToFit = true
    ...
    func callCommonFunctionDaignosticSummary(_ catName: NSString) {
        ...
        let objectArray =  CoreDataHandlerTurkey().fetchCompletePostingSessionTurkey(arrayOfIds.lastObject as! NSNumber)
