...
class CossiBarChartViewController: UIViewController, GI_TtactDelegate, ChartViewDelegate {
    ...
    func setChartDataForFarm(_ dataPoints: [String], values: [Float], lable: NSString) -> BarChartDataSet? {
        ...
        let chartDataSet = BarChartDataSet(values: dataEntries, label: lable as String)
    ...
    func setLineChartDataForFarm(_ dataPoints: [String], values: [Float], lable: NSString) -> LineChartDataSet? {
        ...
        let chartDataSet = LineChartDataSet(values: dataEntries, label: lable as String)
    ...
    func callCommonFunction(_ catName: NSString) {
        ...
        if arrayOfIds.count > 2 {
            ...
            for i in ((arrayOfIds.count)-2...(arrayOfIds.count)).reversed() {
                ...
                let objectArray: NSMutableArray =  CoreDataHandler().fetchAllPostingSession(arrayOfIds[i-1] as! NSNumber).mutableCopy() as! NSMutableArray
    ...
    @IBAction func BtnByWeekPressed(_ sender: UIButton) {
        ...
        let arrayOfIds = AllValidSessions.sharedInstance.allValidSession as NSArray
        let objectArray1 =  CoreDataHandler().fetchAllPostingSession(arrayOfIds[arrayOfIds.count-1] as! NSNumber).mutableCopy() as! NSMutableArray
    ...
    @IBAction func BtnMaximaMicroPressed(_ sender: UIButton) {
       ...
       // self.moreLable.isHidden = false
        ...
        var lastSessionDataArray  = CoreDataHandler().fetchLastSessionDetails(arrayOfIds.lastObject as! NSNumber)
