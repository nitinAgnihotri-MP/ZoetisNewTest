...
class FeedProgramVcTurkey: UIViewController, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource, feedPop {
    ...
    override func viewDidLoad() {
        ...
        cocodiceVacine =  (UserDefaults.standard.value(forKey: "cocci") as? NSArray)!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if MyCoxtinBindersArray.count > 0 {
            ...
            for i in 0..<MyCoxtinBindersArray.count {
                ...
                //                if MyCoxtinBindersArray.count == 1{
                //                    (myFromThirdTextField.value(forKey:"fromDays") as AnyObject).object(at:i) as? String
                //                }
                //                else{
                //                    (myFromThirdTextField.value(forKey:"fromDays") as AnyObject).object(at:2) as? String
                //                }
                if MyCoxtinBindersArray.count == 1 {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if  tableView == farmTableView {
            ...
            if btnTag == 0 {
                ...
                let cocoiControll = (cocodiceVacine.value(forKey: "CocciVaccineName") as AnyObject).object(at: indexPath.row) as! String
                cell.textLabel!.text = cocoiControll
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if tableView == farmTableView {
            ...
            if btnTag == 0 {
                ...
                coccidiosisVaccineDrinkin.text = (cocodiceVacine.value(forKey: "CocciVaccineName") as AnyObject).object(at: indexPath.row) as? String
                CocoiVacId = ((cocodiceVacine.value(forKey: "CocciVaccineId") as AnyObject).object(at: indexPath.row) as? NSNumber)!
    ...
    func addFarmEnd() {
        ...
        if UserDefaults.standard.bool(forKey: "Unlinked") == true {
            let necId1 =  UserDefaults.standard.integer(forKey: "necUnLinked") as! Int
            postingId = necId1 as NSNumber
