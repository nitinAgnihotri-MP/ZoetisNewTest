//
//  GITractTurkey+CoreDataProperties.swift
//  Zoetis -Feathers
//
...
extension GITractTurkey {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<GITractTurkey> {
        return NSFetchRequest<GITractTurkey>(entityName: "GITractTurkey")
    }
