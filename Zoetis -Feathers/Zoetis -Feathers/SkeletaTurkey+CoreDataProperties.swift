//
//  SkeletaTurkey+CoreDataProperties.swift
//  Zoetis -Feathers
//
...
extension SkeletaTurkey {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<SkeletaTurkey> {
        return NSFetchRequest<SkeletaTurkey>(entityName: "SkeletaTurkey")
    }
