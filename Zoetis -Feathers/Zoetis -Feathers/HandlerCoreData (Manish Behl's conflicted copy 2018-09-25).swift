...
class CoreDataHandler: NSObject {
    ...
    func saveHatcheryVacinationInDatabase(_ type: String, strain: String, route: String, age: String, index: Int, dbArray: NSArray, postingId: NSNumber, vaciProgram: String, sessionId: NSNumber, isSync: Bool, lngId: NSNumber) {
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
    ...
    func getHatcheryDataFromServerSingleFromDeviceId(_ dict: NSDictionary, postingId: NSNumber) {
        ...
        for  j in 0..<allkeyArr.count {
            ...
            let vacArray1  =  CoreDataHandler().fetchAddvacinationData(postingId).mutableCopy() as! NSMutableArray
            print(vacArray1)
        ...
        let vacArray2  =  CoreDataHandler().fetchAddvacinationData(postingId).mutableCopy() as! NSMutableArray
        print(vacArray2)
    ...
    func getFieldDataFromServerSingledata(_ dict: NSDictionary, postingId: NSNumber) {
        ...
        for  j in 0..<allkeyArr.count {
            ...
            let vacArray1  =  CoreDataHandler().fetchFieldAddvacinationData(postingId).mutableCopy() as! NSMutableArray
            print(vacArray1)
    ...
    /************************/
    func saveFieldVacinationInDatabase(_ type: String, strain: String, route: String, index: Int, dbArray: NSArray, postingId: NSNumber, vaciProgram: String, sessionId: NSNumber, isSync: Bool, lngId: NSNumber) {
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
    ...
    /*******************************  Setting data Base ********************************************************/
    /***************** save data Skleta ************************************************************************/
    func saveSettingsSkeletaInDatabase(_ strObservationField: String, visibilityCheck: Bool, quicklinks: Bool, strInformation: String, index: Int, dbArray: NSArray, obsId: NSInteger, measure: String, isSync: Bool, lngId: NSNumber, refId: NSNumber) {
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
    ...
    func saveSettingsCocoiiInDatabase(_ strObservationField: String, visibilityCheck: Bool, quicklinks: Bool, strInformation: String, index: Int, dbArray: NSArray, obsId: NSInteger, measure: String, isSync: Bool, lngId: NSNumber, refId: NSNumber) {
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
    ...
    func saveSettingsGITractDatabase(_ strObservationField: String, visibilityCheck: Bool, quicklinks: Bool, strInformation: String, index: Int, dbArray: NSArray, obsId: NSInteger, measure: String, isSync: Bool, lngId: NSNumber, refId: NSNumber) {
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
    ...
    func saveSettingsRespiratoryDatabase(_ strObservationField: String, visibilityCheck: Bool, quicklinks: Bool, strInformation: String, index: Int, dbArray: NSArray, obsId: NSInteger, measure: String, isSync: Bool, lngId: NSNumber, refId: NSNumber) {
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
    ...
    func saveSettingsImmuneDatabase(_ strObservationField: String, visibilityCheck: Bool, quicklinks: Bool, strInformation: String, index: Int, dbArray: NSArray, obsId: NSInteger, measure: String, isSync: Bool, lngId: NSNumber, refId: NSNumber) {
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
    ...
    func saveAntiboticDatabase(_ loginSessionId: NSNumber, postingId: NSNumber, molecule: String, dosage: String, fromDays: String, toDays: String, index: Int, dbArray: NSArray, feedId: NSNumber, feedProgram: String, formName: String, isSync: Bool, feedType: String, cocoVacId: NSNumber, lngId: NSNumber) {
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
    ...
    func saveAlternativeDatabase(_ loginSessionId: NSNumber, postingId: NSNumber, molecule: String, dosage: String, fromDays: String, toDays: String, index: Int, dbArray: NSArray, feedId: NSNumber, feedProgram: String, formName: String, isSync: Bool, feedType: String, cocoVacId: NSNumber, lngId: NSNumber) {
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
    ...
    func saveMyCoxtinDatabase(_ loginSessionId: NSNumber, postingId: NSNumber, molecule: String, dosage: String, fromDays: String, toDays: String, index: Int, dbArray: NSArray, feedId: NSNumber, feedProgram: String, formName: String, isSync: Bool, feedType: String, cocoVacId: NSNumber, lngId: NSNumber) {
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
    ...
    func fecthFrmWithCatnameWithBirdAndObservationWithDelete(farmname: String, necId: NSNumber) -> NSArray {
        ...
        fetchRequest.predicate = NSPredicate(format: "refId != 58")
    ...
    func saveCaptureSkeletaInDatabaseOnSwithCase(catName: String, obsName: String, formName: String, obsVisibility: Bool, birdNo: NSNumber, obsPoint: NSInteger, index: Int, obsId: NSInteger, measure: String, quickLink: NSNumber, necId: NSNumber, isSync: Bool, lngId: NSNumber, refId: NSNumber) {
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
    ...
    func saveCaptureSkeletaInDatabaseOnSwithCaseSingleData(catName: String, obsName: String, formName: String, obsVisibility: Bool, birdNo: NSNumber, obsPoint: NSInteger, index: Int, obsId: NSInteger, measure: String, quickLink: NSNumber, necId: NSNumber, isSync: Bool, necIdSingle: NSNumber, lngId: NSNumber, refId: NSNumber) {
    ...
    func getObservationNameForGITract(refID: [Any]) -> [Any] {
        var nameArray = [Any]()
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
        let managedContext = appDelegate!.managedObjectContext
        let fetchRequest  = NSFetchRequest<NSFetchRequestResult>(entityName: "GITract")
    ...
    func getObservationNameForSkelatal(refID: [Any]) -> [Any] {
        var nameArray = [Any]()
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
        let managedContext = appDelegate!.managedObjectContext
        let fetchRequest  = NSFetchRequest<NSFetchRequestResult>(entityName: "Skeleta")
    ...
    func getObservationNameForImmune(refID: [Any]) -> [Any] {
        var nameArray = [Any]()
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
        let managedContext = appDelegate!.managedObjectContext
        let fetchRequest  = NSFetchRequest<NSFetchRequestResult>(entityName: "Immune")
    ...
    func getObservationNameForRespiratory(refID: [Any]) -> [Any] {
        var nameArray = [Any]()
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
        let managedContext = appDelegate!.managedObjectContext
        let fetchRequest  = NSFetchRequest<NSFetchRequestResult>(entityName: "Respiratory")
    ...
    func getObservationNameForCoccidiosis(refID: [Any]) -> [Any] {
        var nameArray = [Any]()
        let appDelegate    = UIApplication.shared.delegate as? AppDelegate
        let managedContext = appDelegate!.managedObjectContext
        let fetchRequest  = NSFetchRequest<NSFetchRequestResult>(entityName: "Coccidiosis")
    ...
    func deleteDataWithPostingIdStep1dataWithfarmName (_ postingId: NSNumber, farmName: String) {
        //        let appDel  = UIApplication.shared.delegate as! AppDelegate
        //let context = appDel.managedObjectContext
    ...
    func deleteDataWithPostingIdStep2dataCaptureNecViewWithfarmName (_ postingId: NSNumber, farmName: String) {
        //        let appDel  = UIApplication.shared.delegate as! AppDelegate
        //let context = appDel.managedObjectContext
        let fetchPredicate = NSPredicate(format: "necropsyId == %@ AND formName == %@", postingId, farmName)
        let fetchUsers                      = NSFetchRequest<NSFetchRequestResult>(entityName: "CaptureNecropsyViewData")
    ...
    func deleteDataWithPostingIdStep2NotesBirdWithFarmName (_ postingId: NSNumber, farmName: String) {
        //        let appDel  = UIApplication.shared.delegate as! AppDelegate
        //let context = appDel.managedObjectContext
        let fetchPredicate = NSPredicate(format: "necropsyId == %@ AND formName == %@", postingId, farmName)
        let fetchUsers                      = NSFetchRequest<NSFetchRequestResult>(entityName: "NotesBird")
    ...
    func deleteDataWithPostingIdStep2CameraIamgeWithFarmName (_ postingId: NSNumber, farmName: String) {
