//
//  Respiratory+CoreDataProperties.swift
//  Zoetis -Feathers
//
...
extension Respiratory {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<Respiratory> {
        return NSFetchRequest<Respiratory>(entityName: "Respiratory")
    }
