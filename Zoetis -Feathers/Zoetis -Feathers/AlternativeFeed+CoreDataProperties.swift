//
//  AlternativeFeed+CoreDataProperties.swift
//  Zoetis -Feathers
//
...
extension AlternativeFeed {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<AlternativeFeed> {
        return NSFetchRequest<AlternativeFeed>(entityName: "AlternativeFeed")
    }
