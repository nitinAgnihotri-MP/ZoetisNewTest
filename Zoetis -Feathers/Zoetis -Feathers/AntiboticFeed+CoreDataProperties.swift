//
//  AntiboticFeed+CoreDataProperties.swift
//  Zoetis -Feathers
//
...
extension AntiboticFeed {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<AntiboticFeed> {
        return NSFetchRequest<AntiboticFeed>(entityName: "AntiboticFeed")
    }
