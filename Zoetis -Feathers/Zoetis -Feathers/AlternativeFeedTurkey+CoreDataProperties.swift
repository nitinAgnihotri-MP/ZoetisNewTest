//
//  AlternativeFeedTurkey+CoreDataProperties.swift
//  Zoetis -Feathers
//
...
extension AlternativeFeedTurkey {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<AlternativeFeedTurkey> {
        return NSFetchRequest<AlternativeFeedTurkey>(entityName: "AlternativeFeedTurkey")
    }
