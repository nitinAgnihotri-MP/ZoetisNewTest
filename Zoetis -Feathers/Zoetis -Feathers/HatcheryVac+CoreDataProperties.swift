//
//  HatcheryVac+CoreDataProperties.swift
//  Zoetis -Feathers
//
...
extension HatcheryVac {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<HatcheryVac> {
        return NSFetchRequest<HatcheryVac>(entityName: "HatcheryVac")
    }
