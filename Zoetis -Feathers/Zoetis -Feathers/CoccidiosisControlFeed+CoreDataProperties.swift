//
//  CoccidiosisControlFeed+CoreDataProperties.swift
//  Zoetis -Feathers
//
...
extension CoccidiosisControlFeed {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<CoccidiosisControlFeed> {
        return NSFetchRequest<CoccidiosisControlFeed>(entityName: "CoccidiosisControlFeed")
    }
